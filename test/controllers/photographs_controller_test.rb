...
class PhotographsControllerTest < ActionController::TestCase
  ...
  test "should create photograph" do
    assert_difference('Photograph.count') do
      post :create, photograph: { description: @photograph.description, image: @photograph.image, title: @photograph.title }
    end
  ...
  test "should update photograph" do
    patch :update, id: @photograph, photograph: { description: @photograph.description, image: @photograph.image, title: @photograph.title }
    assert_redirected_to photograph_path(assigns(:photograph))
  end
